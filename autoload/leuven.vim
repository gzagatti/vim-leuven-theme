...
let g:leuven#palette.gray_whitespace  = ['#dadad7', 253]
...
let g:leuven#palette.green_margins_fg = ['#006666', 23]
...
let g:leuven#palette.blue_content_fg  = ['#000088', 18]
...
let g:leuven#palette.blue_margins_bg  = ['#e9f3f1', 194]
...
" original palette {{{
if !exists('g:leuven_original')
  let g:leuven_original = 0
endif
if g:leuven_original == 1
  let g:leuven#palette.fg               = ['#000000', 16]
  let g:leuven#palette.bg               = ['#ffffff', 231]
  let g:leuven#palette.green_margins_fg = g:leuven#palette.gray_dark_fg
  let g:leuven#palette.blue_margins_bg  = ['#e2e1d5', 187]
endif
" }}}
