...
" palette {{{
 ...
 let g:leuven#palette.fg                     = ['#333333', 7]
 ...
 let g:leuven#palette.green_h3_bg            = ['#efffef', 12]
 ...
 let g:leuven#palette.blue_h1_fg             = ['#123555', 17]
 let g:leuven#palette.blue_block_content_fg  = ['#000088', 18]
 let g:leuven#palette.blue_fg                = ['#0000ff', 4]
 let g:leuven#palette.blue_on_bg             = ['#85ceeb', 25]
 let g:leuven#palette.blue_dark_bg           = ['#5974ab', 61]
 ...
 let g:leuven#palette.blue_light_bg          = ['#ebf4fe', 14]
